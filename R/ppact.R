...
#'
#' @format A data frame with primary outcome, cluster-level, individual level covariates:
#' \describe{
#'   \item{SID}{Study ID}
#'   \item{CLUST}{Cluster}
...
#'   \item{n}{cluster size}
#' }
#' @source ClinicalTrials.gov: NCT02113592, The manuscript of the study's main outcomes is published in the Annals of Internal Medicine (https://doi.org/10.7326/M21-1436).
#'
"ppact"
