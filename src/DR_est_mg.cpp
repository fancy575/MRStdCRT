...
Rcpp::List DR_est_mg(const arma::vec& ftime,const arma::vec& delta, const arma::vec trt,
  ...
  arma::mat dM1_c = dN_c - dlambda0_c_expand1 % c_exp1_expand % risk;


  // For Kc and H1

  arma::mat Surv0_c_expand1 = repmat(Surv0_c1.t(),N,1);
  arma::mat Surv0_s_expand1 = repmat(Surv0_s1.t(),N,1);




  arma::mat Kc1 = pow(Surv0_c_expand1,c_exp1_expand);
  arma::mat H11 = pow(Surv0_s_expand1,s_exp1_expand);
  ...
  arma::mat dM0_c = dN_c - dlambda0_c_expand0 % c_exp0_expand % risk;


  // For Kc and H1

  arma::mat Surv0_c_expand0 = repmat(Surv0_c0.t(),N,1);
  arma::mat Surv0_s_expand0 = repmat(Surv0_s0.t(),N,1);




  arma::mat Kc0 = pow(Surv0_c_expand0,c_exp0_expand);
  arma::mat H10 = pow(Surv0_s_expand0,s_exp0_expand);
